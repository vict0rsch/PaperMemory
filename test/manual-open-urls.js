...
(() => {
    const urls = [
        ...
        ["aip", "https://pubs.aip.org/aip/aml/article/1/1/010901/2878738/Deep-language-models-for-interpretative-and?searchresult=1"],
    ...
    function openNext() {
        ...
        getPaperCount().then((prevCount) => {
            console.log(`[${i + 1}/${urls.length}] Opening ${source} (papers: ${prevCount})`);
