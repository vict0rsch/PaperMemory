...
// pkg/dist-src/defaults.js
var userAgent = `octokit-endpoint.js/${VERSION} ${(0, _universalUserAgent.getUserAgent)()}`;
var DEFAULTS = {
  method: "GET",
...
},{"universal-user-agent":7}],3:[function(require,module,exports){
"use strict";
...
var logOnceCode = (0, _once.default)(deprecation => console.warn(deprecation));
var logOnceHeaders = (0, _once.default)(deprecation => console.warn(deprecation));
...
},{"deprecation":5,"once":6}],4:[function(require,module,exports){
"use strict";
...
},{"@octokit/endpoint":2,"@octokit/request-error":3,"universal-user-agent":7}],5:[function(require,module,exports){
"use strict";
...
},{"wrappy":8}],7:[function(require,module,exports){
