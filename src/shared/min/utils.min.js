...
`+`url={${e}},
`)+`year={${l}}
`+"}",r=bibtexToString(r)}var n=e.replace("/hash/","/file/").replace("-Abstract.html","-Paper.pdf"),e=`NeurIPS-${l}_`+a.slice(0,8),c="NeurIPS "+l;return{author:i,bibtex:r,conf:c,id:e,key:s,note:"Accepted @ "+c,pdfLink:n,title:o,venue:"NeurIPS",year:l}},makeCVFPaper=async e=>{const a=await fetchCvfHTML(e),t=(new DOMParser).parseFromString(a.replaceAll("\n",""),"text/html");var n=t.getElementById("papertitle").innerText.trim(),r=t.querySelector("#authors i").innerText.split(",").map(e=>e.trim()).join(" and "),{year:i,id:o,conf:l}=parseCVFUrl(e);let s="";if(e.endsWith(".pdf"))s=e;else{let e=Array.from(t.getElementsByTagName("a")).filter(e=>"pdf"===e.innerText)[0].getAttribute("href");(e=e.startsWith("../")?e.replaceAll("../",""):e).startsWith("/")||(e="/"+e),s="http://openaccess.thecvf.com"+e}e=`Accepted @ ${l} `+i;const c=bibtexToString(t.querySelector(".bibref").innerText);var p=c.split("{")[1].split(",")[0];return{author:r,bibtex:c,conf:l,id:o,key:p,note:e,pdfLink:s,title:n,venue:l,year:i}},makeOpenReviewBibTex=(e,a)=>{var t=e.content.title,n=e.content.authors.join(" and "),r=e.cdate?new Date(e.cdate).getFullYear():"0000",e=(e.cdate||log("makeOpenReviewBibTex: no cdate found in",e),e.content.authors[0].split(" ").last()),i="";return i+`@inproceedings{${e=(e+=r)+firstNonStopLowercase(t)},
`+`title={${t}},
`+`author={${n}},
`+`year={${r}},
`+`url={${a}},
`+"}"},makeOpenReviewPaper=async e=>{var a=await fetchOpenReviewNoteJSON(e),t=await fetchOpenReviewForumJSON(e),a=a.notes[0],t=t.notes,n=a.content.title,r=a.content.authors.join(" and "),i=bibtexToString(a.content._bibtex||makeOpenReviewBibTex(a,e)),o=bibtexToObject(i),l=o.citationKey,o=o.year;let s;s=a.pdf?"https://openreview.net/pdf?id="+a.id:(a.html||e).replace("/forum?id=","/pdf?id=");const c=a.invitation.split("/");let p=c[0].split(".")[0],d=c.slice(1).join("/").split("-")[0].replaceAll("/"," ").replace(" Conference",""),u=p,h=!1;global.overrideORConfs.hasOwnProperty(p)&&(u=global.overrideORConfs[p],h=!0),h&&(d=d.replace(u,""),p=u);e=(p+" "+d).replace(/ \d\d\d\d/g,"").replace(/\s\s+/g," "),a=`OR-${p}-${o}_`+a.id;let m,f,g,y="";return(m=t.filter(e=>e&&e.content&&-1<["Final Decision","Paper Decision","Acceptance Decision"].indexOf(e.content.title)))&&0<m.length&&(f=m[0].content.decision.split(" ").map((e,a)=>0===a?e+"ed":e).join(" "),g=f+` @ ${e} `+o,f.toLowerCase().indexOf("rejected")<0&&(y=e)),{author:r,bibtex:i,conf:e,id:a,key:l,note:g="Anonymous"===r?`Under review @ ${e} ${o} (${(new Date).toLocaleDateString()})`:g,pdfLink:s,title:n,venue:y,year:o}},makeBioRxivPaper=async e=>{var a=e.replace(".full.pdf",""),t="https://api.biorxiv.org//details/biorxiv/"+e.split("/").slice(-2).join("/").replace(".full.pdf","").split("v")[0];const n=await fetch(t).then(e=>e.json());if("ok"!==n.messages[0].status)throw new Error(t+" returned "+n.messages[0].status);const r=n.collection.last(),i=await fetchText(a),o=(new DOMParser).parseFromString(i.replaceAll("\n",""),"text/html");t=o.querySelector(".bibtext a").getAttribute("href");const l=bibtexToString(await(await fetch(t)).text());var a=extractAuthor(l),t=await parseIdFromUrl(e),s=l.split("\n")[0].split("{")[1].replace(",","").trim(),e=cleanBiorxivURL(e)+".full.pdf",c=r.title,p=r.date.split("-")[0];return{author:a,bibtex:l,conf:"BioRxiv",id:t,key:s,note:"",pdfLink:e,title:c,venue:"",year:p}},makePMLRPaper=async e=>{var a=e.split("/").last().split(".")[0],t=await parseIdFromUrl(e);const n=e.includes(".html")?e:e.split("/").slice(0,-2).join("/")+`/${a}.html`;e=n.replace(".html","")+`/${a}.pdf`;const r=await fetchDom(n);r.getElementById("button-bibtex1").getAttribute("onclick").match(/https.+\.bib/)[0];const i=r.getElementById("bibtex").innerText.replaceAll("\t"," ").replaceAll(/\s\s+/g," ");let o=i;for(const u of i.match(/,\ ?\w+ ?= ?{/g))o=o.replace(u,u.replace(", ",",\n    ").replace(" = ","="));o.endsWith("}}")&&(o=o.slice(0,-2)+"}\n}"),o=bibtexToString(o);var l=extractAuthor(o),s=r.getElementsByTagName("h1")[0].innerText,c=extractBibtexValue(o,"year");let p=extractBibtexValue(o,"booktitle").replaceAll("Proceedings of the",""),d=p;note="Accepted @ "+p+`(${c})`;for(const h in global.overridePMLRConfs)if(p.includes(h)){d=global.overridePMLRConfs[h],p=d+" "+c,note="Accepted @ "+p;break}return{author:l,bibtex:o,conf:p,id:t,key:a,note:note,pdfLink:e,title:s,venue:d,year:c}},findACLValue=(e,a)=>{return Array.from(e.querySelectorAll("dt")).filter(e=>e.innerText.includes(a))[0].nextElementSibling.innerText},makeACLPaper=async e=>{e=e.replace(".pdf","");const a=await fetchDom(e);e=a.getElementById("citeBibtexContent");if(e){var t=a.getElementById("title").innerText,e=bibtexToString(e.innerText);const s=bibtexToObject(e);var n=s.year,r=s.author.replace(/\s+/g," ").split(" and ").map(e=>e.split(",").map(e=>e.trim()).reverse().join(" ")).join(" and "),i=s.citationKey,o=findACLValue(a,"Venue"),l=findACLValue(a,"PDF");return{author:r,bibtex:e,conf:o,id:`ACL-${o}-${n}_`+findACLValue(a,"Anthology ID"),key:i,note:`Accepted @ ${o} `+n,pdfLink:l,title:t,venue:o,year:n}}},makePNASPaper=async e=>{e=e.replace(".full.pdf","").replace(/\/doi\/e?pdf\//,"/doi/abs/");const a=await fetchDom(e);var t=a.getElementsByTagName("h1")[0].innerText,n=Array.from(a.querySelectorAll(".authors span[property='author'] a:not([property='email']):not(.orcid-id)")).filter(e=>!e.getAttribute("href").includes("mailto:")).map(e=>e.innerText).join(" and "),r=a.querySelector("span[property='datePublished']").innerText.match(/\d{4}/g)[0],i=`PNAS-${r}_`+(e.endsWith("/")?e.split("/").slice(-2):e.split("/").slice(-1))[0];const o=e.includes("/doi/pdf/")||e.includes("/doi/epdf/")?e.replace("/doi/epdf/","/doi/pdf/"):e.replace("/doi/abs/","/doi/pdf/").replace("/doi/full/","/doi/pdf/");var e=Array.from(a.querySelector(".self-citation").getElementsByTagName("a")).map(e=>e.getAttribute("href")).filter(e=>e.includes("https://doi.org"))[0].split("/").slice(-2).join("/"),l="doi:"+e;return{author:n,bibtex:bibtexToString(`@article{${l}, author={${n}}, title={${t}}, journal = {Proceedings of the National Academy of Sciences}, year={${r}}, doi={${e}}, eprint={${o}}, URL={${o.replace("/doi/pdf/","/doi/abs/")}} }`),id:i,key:l,note:`Published @ PNAS (${r})`,pdfLink:o,title:t,venue:"PNAS",year:r}},makeNaturePaper=async e=>{var a=(e=e.replace(".pdf","").split("#")[0])+".pdf",t=e.split("/").last();const n=await fetchDom(e);e=n.querySelector("h1.c-article-title").innerText;const r=Array.from(n.querySelectorAll("ul.c-article-author-list li")).map(e=>e.innerText.replace(/(\ ?,)|&|…|\d/g,"").split(/orcid/i)[0].trim()).filter(e=>0<e.length).join(" and ");var i=n.querySelector(".c-article-info-details").innerText.match(/\(\d{4}\)/)[0].replace(/\(|\)/g,""),o=n.querySelector(".c-article-info-details [data-test]").innerText,t=`Nature-${i}_`+t;let l;for(const d of[".c-bibliographic-information__citation",".c-bibliographic-information__value"])if(l=document.querySelector(d)?.innerText.split("https://doi.org/")[1])break;l=l||Array.from(n.getElementsByTagName("span")).map(e=>e.innerText).filter(e=>e.includes("https://doi.org"))[0];var s=""+r.split(" ")[1]+i+firstNonStopLowercase(e);let c={citationKey:s,entryType:"article",author:r,title:e,journal:o,year:i};l&&(c.doi=l,c.url="https://doi.org/"+l);var p=bibtexToString(c);return{author:r,bibtex:p,id:t,key:s,note:`Published @ ${o} (${i})`,pdfLink:a,title:e,venue:o,year:i}},makeACSPaper=async e=>{const a=(e=e.replace("pubs.acs.org/doi/pdf/","pubs.acs.org/doi/").split("?")[0]).replace("/abs/","/").split("/doi/")[1];console.log("doi: ",a);e=`https://pubs.acs.org/action/downloadCitation?doi=${a}&include=cit&format=bibtex&direct=true`,e=await fetchText(e);const t=bibtexToObject(e);var n=t.author.replaceAll("\n","").trim(),r=t.title.trim(),i=t.year.trim(),o=t.citationKey.trim(),l="https://pubs.acs.org/doi/pdf/"+a,s=`Published @ ${t.journal} (${t.year})`;return{author:n,bibtex:e,id:"ACS_"+a.replaceAll(".","").replaceAll("/",""),key:o,note:s,pdfLink:l,title:r,venue:t.journal,year:i}},makeIOPPaper=async e=>{(e=e.split("#")[0]).endsWith("/pdf")&&(e=e.slice(0,-4));const a=await fetchDom(e);var t=Array.from(a.querySelectorAll(".btn-multi-block a")).filter(e=>"BibTeX"===e.innerText).map(e=>e.getAttribute("href"))[0],t="https://"+parseUrl(e).host+t,t=await fetchText(t);const n=bibtexToObject(t);var r=n.author.replaceAll("\n","").trim(),i=n.title.trim(),o=n.year.trim(),l=n.citationKey.trim(),s=e+"/pdf",c=n.journal,p=`Published @ ${c} (${o})`;const d=e.split("/article/").last();return{author:r,bibtex:t,id:"IOPscience_"+d.replaceAll(".","").replaceAll("/",""),key:l,note:p,pdfLink:s,title:i,venue:c,year:o}},makeJMLRPaper=async e=>{var a=(e=(e=(e=e.includes("/papers/volume")?e.replace("/papers/volume","/papers/v"):e).endsWith(".pdf")?e.split("/").slice(0,-1).join("/"):e).replace(".html","")).split("/").last(),t=e+".bib",t=await fetchText(t);const{author:n,year:r,title:i,citationKey:o}=bibtexToObject(t);return{author:n,bibtex:t,id:`JMLR-${r}_`+a,key:o.trim(),note:`Published @ JMLR (${r})`,pdfLink:e.replace("/papers/v","/papers/volume")+`/${a}.pdf`,title:i,venue:"JMLR",year:r}},makePMCPaper=async e=>{var a=e.match(/PMC\d+/)[0].replace("PMC",""),t=e.split("PMC"+a)[0]+"PMC"+a;const n=await(await fetch(`https://api.ncbi.nlm.nih.gov/lit/ctxp/v1/pmc/?format=csl&id=${a}&download=true`)).json();var r=(n["epub-date"]||n.issued)["date-parts"][0][0],i=n.author.map(e=>e.given+" "+e.family).join(" and "),o=n["container-title"].split(" ").map(e=>e.capitalize()).join(" "),l=n.title,a=`PMC-${r}_`+a,s=""+n.author[0].family+r+firstNonStopLowercase(l),c=bibtexToString({entryType:"article",citationKey:s,journal:o,issn:n.ISSN,volume:n.volume,page:n.page,doi:n.DOI,PMID:n.PMID,PMCID:n.PMCID,publisher:n.publisher,author:i,title:l});let p;if(isPdfUrl(e))p=e;else{const h=n.DOI.split("/")[1].split("-");var e=h[0].match(/\d+/)[0],d=h[1].replace(h[1].match(/^0*/)[0],""),u=h[2].replace(h[2].match(/^0*/)[0],"");p=t+`/pdf/${e}_${d}_Article_${u}.pdf`}return{author:i,bibtex:c,id:a,key:s,note:`Published @ ${o} (${r})`,pdfLink:p,title:l,venue:o,year:r}},makePubMedPaper=async e=>{const a=await fetchDom(e.split("?")[0]),t=Array.from(a.getElementsByTagName("meta")).filter(e=>e.getAttribute("name")?.includes("citation_")),n=Object.fromEntries(t.map(e=>[e.getAttribute("name").replace("citation_",""),e.getAttribute("content")])),r=document.querySelector("div.authors-list").innerText.replace(/\d/gi,"").split(",").map(e=>e.trim()).join(" and ");var e=n.title,i=n.journal_title,o=n.date.split("/")[2],l=`PubMed-${o}_`+n.pmid,s=""+r.split(" and ")[0].split(" ").last()+o+firstNonStopLowercase(n.title),c={entryType:"article",citationKey:s,publisher:n.publisher,doi:n.doi,issn:n.issn,journal:i,year:o,author:r},c=bibtexToString(c),p=`Accepted @ ${journal} (${o})`;return{author:r,bibtex:c,id:l,key:s,note:p,pdfLink:"",title:e,venue:i,year:o}},makeIJCAIPaper=async e=>{const a=e.endsWith(".pdf")?e.replace(".pdf","").split("/").last().match(/[1-9]\d*/)[0]:e.split("/").last();e=e.match(/proceedings\/\d+/gi)[0].split("/")[1];const t=(await fetchText(`https://www.ijcai.org/proceedings/${e}/bibtex/`+a)).replace(/}\n/gi,"},\n");var n=bibtexToObject(t.split("\n").filter(e=>!/note\s+=/gi.test(e)).join("\n")),r=n.citationKey,i=n.title,n=flipAndAuthors(n.author),o=`IJCAI-${e}_`+a,l=`Accepted @ IJCAI (${e})`,s=a.padStart(4,0);return{author:n,bibtex:t,id:o,key:r,note:l,pdfLink:`https://www.ijcai.org/proceedings/${e}/${s}.pdf`,title:i,venue:"IJCAI",year:e}},makeACMPaper=async e=>{let a;a=isPdfUrl(e)?e:e.replace("/doi/","/doi/pdf/");const t=await fetchDom(e.replace("/doi/pdf/","/doi/"));var n=t.querySelector(".citation__title").innerText,r=Array.from(t.querySelectorAll("ul[ariaa-label='authors'] li.loa__item .loa__author-name")).map(e=>e.innerText.replace(",","").trim()).join(" and ");const i=t.querySelector(".issue-item__detail a").innerText;var o=i.split("'")[0].trim(),l="20"+i.split("'")[1].split(":")[0].trim();const s=a.split("/doi/pdf/")[1];var c=`Accepted @ ${o} (${l})`,p=s;return{author:r,bibtex:bibtexToString({entryType:"article",citationKey:s,journal:o,author:r,title:n,year:l,publisher:"Association for Computing Machinery",address:"New York, NY, USA",url:e.replace("/doi/pdf/","/doi/")}),id:`ACM-${l}_`+s.replaceAll(/(\.|\/)/gi,""),key:p,note:c,pdfLink:a,title:n,venue:o,year:l}},makeIEEEPaper=async e=>{isPdfUrl(e)&&(e=`https://ieeexplore.ieee.org/document/${e.split("/stamp/stamp.jsp?tp=&arnumber=")[1].match(/\d+/)[0]}/`,console.log("url: ",e));const a=await fetchDom(e),t=JSON.parse(Array.from(a.getElementsByTagName("script")).filter(e=>e.innerHTML?.includes("metadata="))[0].innerHTML.split("metadata=")[1].trim().replace(/;$/,""));var n=t.title,r=t.authors.map(e=>e.name).join(" and "),i=t.publicationYear,e=""+parseUrl(e).origin+t.pdfUrl,o=t.publicationTitle,l=t.articleId;return{author:r,bibtex:bibtexToString({entryType:"article",citationKey:l,journal:o,volume:t.volume,pages:t.startPage+"-"+t.endPage,doi:t.doi,title:n,year:i,author:r}),id:`IEEE-${i}_`+l,key:l,note:`Accepted @ ${o} (${i})`,pdfLink:e,title:n,venue:o,year:i}},makeSpringerPaper=async a=>{const e=[...global.sourceExtras.springer.types,"content/pdf"];var t=e.find(e=>a.includes(`/${e}/`));if(!t)throw new Error(`Could not find Springer type for ${a} (known: ${e.join(", ")})`);var n=a.split(`/${t}/`)[1].split("?")[0].replace(".pdf",""),r=await fetchJSON(`https://api.crossref.org/works/${n}?mailto=schmidtv%40mila.quebec`),r=extractCrossrefData(r);if(!r)throw new Error("Aborting Springer paper parsing, see error above");var{author:i,bibtex:o,citationKey:l,year:s,title:c,venue:p}=r;return{author:i,bibtex:o,id:`Springer-${s}_`+miniHash(n),key:l,note:`Published @ ${p} (${s})`,pdfLink:r.pdf??("content/pdf"===t?a:a.replace(`/${t}/`,"/content/pdf/")+".pdf"),title:c,venue:p,year:s,extra:{url:"https://doi.org/"+n}}},tryPWCMatch=async e=>{e={type:"papersWithCode",pwcPrefs:await getStorage("pwcPrefs")??{},paper:e};return sendMessageToBackground(e)},tryCrossRef=async e=>{try{var a="https://api.crossref.org/works?rows=1&mailto=schmidtv%40mila.quebec&select=event%2Ctitle&query.title="+encodeURI(e.title);const n=await fetch(a).then(e=>e.json());if("ok"!==n.status)return log(`[Crossref] ${a} returned `+n.message.status),{note:null};if(0===n.message.items.length)return{note:null};if(n.message.items[0].title[0].toLowerCase().replaceAll("\n"," ").replaceAll(/\s\s+/g," ")!==e.title.toLowerCase().replaceAll("\n"," ").replaceAll(/\s\s+/g," "))return{note:null};if(!n.message.items[0].event||!n.message.items[0].event.name)return{note:null};info("Found a CrossRef match");var t=n.message.items[0].event.name.trim();return{venue:t,note:`Accepted @ ${t} -- [crossref.org]`}}catch(e){return log("[Crossref]",e),{note:null}}},tryDBLP=async e=>{try{var a,t,n,r,i=encodeURI(e.title);const o=await fetch(`https://dblp.org/search/publ/api?q=${i}&format=json`).then(e=>e.json());if(!(o.result&&o.result.hits&&o.result.hits.hit&&o.result.hits.hit.length))return{note:null};for(const l of o.result.hits.hit.sort((e,a)=>parseInt(e.info.year,10)-parseInt(a.info.year,10)))if(decodeHtml(l.info.title.toLowerCase().replaceAll("\n"," ").replaceAll(".","").replaceAll(/\s\s+/g," "))===e.title.toLowerCase().replaceAll("\n"," ").replaceAll(".","").replaceAll(/\s\s+/g," ")&&"CoRR"!==l.info.venue)return info("Found a DBLP match"),a=await fetchText(l.info.url+".bib"),t=l.info.venue.toLowerCase().replaceAll(".","").trim(),n=(global.journalAbbreviations[t]||l.info.venue).trim(),r=l.info.year,l.info.url,{venue:n,note:`Accepted @ ${n} ${r} -- [dblp.org]`,bibtex:a};return{note:null}}catch(e){return log("[DBLP]",e),{note:null}}},tryPreprintMatch=async(e,a=!1)=>{let t,n,r,i;return a&&(a={type:"papersWithCode",pwcPrefs:await getStorage("pwcPrefs")??{},paper:e},a=await sendMessageToBackground(a),pwcUrl=!e.codeLink&&a?.url,pwcNote=!e.note&&a?.note,pwcVenue=!e.venue&&a?.venue,pwcUrl&&(i=a),pwcNote&&(t=pwcNote),pwcVenue&&(n=pwcVenue)),n?{note:t,venue:n,bibtex:r}:(dblpMatch=await tryDBLP(e),t=dblpMatch.note,n=dblpMatch.venue,r=dblpMatch.bibtex,t||(log("[DBLP] No publication found"),crossRefMatch=await tryCrossRef(e),t=crossRefMatch.note,n=crossRefMatch.venue),t||log("[CrossRef] No publication found"),{note:t,venue:n,bibtex:r,code:i})},initPaper=async e=>{e.note||(e.note=""),e.md=`[${e.title}](${e.pdfLink})`,e.tags=[],e.codeLink="",e.favorite=!1,e.favoriteDate="",e.addDate=(new Date).toJSON(),e.lastOpenDate=e.addDate,e.count=1,e.code={};for(const a in e)e.hasOwnProperty(a)&&"string"==typeof e[a]&&(e[a]=e[a].trim());return e=await autoTagPaper(e),validatePaper(e),e},autoTagPaper=async t=>{try{var e,n,r=await getStorage("autoTags");if(!r||!r.length)return t;let a=new Set;for(const i of r)i.tags?.length&&(i.title||i.author)&&(e=!i.title||new RegExp(i.title,"i").test(t.title),n=!i.author||new RegExp(i.author,"i").test(t.author),e&&n&&i.tags.forEach(e=>a.add(e)));return t.tags=Array.from(a).sort(),t.tags.length&&log("Automatically adding tags:",t.tags),t}catch(e){return log("Error auto-tagging:",e),log("Paper:",t),t}},makePaper=async(e,a,t)=>{let n;if(e.arxiv)(n=await makeArxivPaper(t)).source="arxiv";else if(e.neurips)(n=await makeNeuripsPaper(a)).source="neurips";else if(e.cvf)(n=await makeCVFPaper(a)).source="cvf";else if(e.openreview)(n=await makeOpenReviewPaper(a)).source="openreview";else if(e.biorxiv)(n=await makeBioRxivPaper(a)).source="biorxiv";else if(e.pmlr)(n=await makePMLRPaper(a)).source="pmlr";else if(e.acl)(n=await makeACLPaper(a))&&(n.source="acl");else if(e.pnas)(n=await makePNASPaper(a))&&(n.source="pnas");else if(e.nature)(n=await makeNaturePaper(a))&&(n.source="nature");else if(e.acs)(n=await makeACSPaper(a))&&(n.source="acs");else if(e.iop)(n=await makeIOPPaper(a))&&(n.source="iop");else if(e.jmlr)(n=await makeJMLRPaper(a))&&(n.source="jmlr");else if(e.pmc)(n=await makePMCPaper(a))&&(n.source="pmc");else if(e.ijcai)(n=await makeIJCAIPaper(a))&&(n.source="ijcai");else if(e.acm)(n=await makeACMPaper(a))&&(n.source="acm");else if(e.ieee)(n=await makeIEEEPaper(a))&&(n.source="ieee");else{if(!e.springer)throw new Error("Unknown paper source: "+JSON.stringify({is:e,url:a,id:t}));(n=await makeSpringerPaper(a))&&(n.source="springer")}if(void 0!==n)return initPaper(n)},findFuzzyPaperMatch=e=>{for(const t in global.state.papers)if("__dataVersion"!==t){var a=global.state.papers[t];if(Math.abs(a.title.length-e.title.length)<global.fuzzyTitleMatchMinDist)if(levenshtein(a.title,e.title)<global.fuzzyTitleMatchMinDist)return a.id}return null};"undefined"!=typeof module&&null!=module.exports&&(module.exports={decodeHtml:decodeHtml,flipAuthor:flipAuthor,flipAndAuthors:flipAndAuthors,fetchArxivXML:fetchArxivXML,fetchCvfHTML:fetchCvfHTML,fetchOpenReviewNoteJSON:fetchOpenReviewNoteJSON,fetchOpenReviewForumJSON:fetchOpenReviewForumJSON,fetchDom:fetchDom,fetchText:fetchText,makeArxivPaper:makeArxivPaper,makeNeuripsPaper:makeNeuripsPaper,makeCVFPaper:makeCVFPaper,makeOpenReviewBibTex:makeOpenReviewBibTex,makeOpenReviewPaper:makeOpenReviewPaper,makeBioRxivPaper:makeBioRxivPaper,makePMLRPaper:makePMLRPaper,findACLValue:findACLValue,makeACLPaper:makeACLPaper,makePNASPaper:makePNASPaper,makeNaturePaper:makeNaturePaper,makeACSPaper:makeACSPaper,makeIOPPaper:makeIOPPaper,makeJMLRPaper:makeJMLRPaper,makePMCPaper:makePMCPaper,makePubMedPaper:makePubMedPaper,makeIJCAIPaper:makeIJCAIPaper,makeACMPaper:makeACMPaper,makeIEEEPaper:makeIEEEPaper,tryCrossRef:tryCrossRef,tryDBLP:tryDBLP,tryPreprintMatch:tryPreprintMatch,tryPWCMatch:tryPWCMatch,initPaper:initPaper,autoTagPaper:autoTagPaper,makePaper:makePaper,findFuzzyPaperMatch:findFuzzyPaperMatch});