...
`+`url={${e}},
`)+`year={${l}}
`+"}",i=bibtexToString(i)}var n=e.replace("/hash/","/file/").replace("-Abstract.html","-Paper.pdf"),e=`NeurIPS-${l}_`+a.slice(0,8),c="NeurIPS "+l;return{author:r,bibtex:i,conf:c,id:e,key:s,note:"Accepted @ "+c,pdfLink:n,title:o,venue:"NeurIPS",year:l}},makeCVFPaper=async e=>{const a=await fetchCvfHTML(e),t=(new DOMParser).parseFromString(a.replaceAll("\n",""),"text/html");var n=t.getElementById("papertitle").innerText.trim(),i=t.querySelector("#authors i").innerText.split(",").map(e=>e.trim()).join(" and "),{year:r,id:o,conf:l}=parseCVFUrl(e);let s="";if(e.endsWith(".pdf"))s=e;else{const d=Array.from(t.getElementsByTagName("a")).filter(e=>"pdf"===e.innerText)[0].getAttribute("href");(d=d.startsWith("../")?d.replaceAll("../",""):d).startsWith("/")||(d="/"+d),s="http://openaccess.thecvf.com"+d}e=`Accepted @ ${l} `+r;const c=bibtexToString(t.querySelector(".bibref").innerText);var p=c.split("{")[1].split(",")[0];return{author:i,bibtex:c,conf:l,id:o,key:p,note:e,pdfLink:s,title:n,venue:l,year:r}},makeOpenReviewBibTex=(e,a)=>{var t=e.content.title,n=e.content.authors.join(" and "),i=e.cdate?new Date(e.cdate).getFullYear():"0000",e=(e.cdate||log("makeOpenReviewBibTex: no cdate found in",e),e.content.authors[0].split(" ").last()),r="";return r+`@inproceedings{${e=(e+=i)+firstNonStopLowercase(t)},
`+`title={${t}},
`+`author={${n}},
`+`year={${i}},
`+`url={${a}},
`+"}"},makeOpenReviewPaper=async e=>{var a=await fetchOpenReviewNoteJSON(e),t=await fetchOpenReviewForumJSON(e),a=a.notes[0],t=t.notes,n=a.content.title,i=a.content.authors.join(" and "),r=bibtexToString(a.content._bibtex||makeOpenReviewBibTex(a,e)),o=bibtexToObject(r),l=o.citationKey,o=o.year;let s;s=a.pdf?"https://openreview.net/pdf?id="+a.id:(a.html||e).replace("/forum?id=","/pdf?id=");const c=a.invitation.split("/");let p=c[0].split(".")[0],d=c.slice(1).join("/").split("-")[0].replaceAll("/"," ").replace(" Conference",""),u=p,h=!1;global.overrideORConfs.hasOwnProperty(p)&&(u=global.overrideORConfs[p],h=!0),h&&(d=d.replace(u,""),p=u);e=(p+" "+d).replace(/ \d\d\d\d/g,"").replace(/\s\s+/g," "),a=`OR-${p}-${o}_`+a.id;let m,f,g,y="";return(m=t.filter(e=>e&&e.content&&-1<["Final Decision","Paper Decision","Acceptance Decision"].indexOf(e.content.title)))&&0<m.length&&(f=m[0].content.decision.split(" ").map((e,a)=>0===a?e+"ed":e).join(" "),g=f+` @ ${e} `+o,f.toLowerCase().indexOf("rejected")<0&&(y=e)),{author:i,bibtex:r,conf:e,id:a,key:l,note:g="Anonymous"===i?`Under review @ ${e} ${o} (${(new Date).toLocaleDateString()})`:g,pdfLink:s,title:n,venue:y,year:o}},makeBioRxivPaper=async e=>{var a=e.replace(".full.pdf",""),t="https://api.biorxiv.org//details/biorxiv/"+e.split("/").slice(-2).join("/").replace(".full.pdf","").split("v")[0];const n=await fetch(t).then(e=>e.json());if("ok"!==n.messages[0].status)throw new Error(t+" returned "+n.messages[0].status);const i=n.collection.last(),r=await fetchText(a),o=(new DOMParser).parseFromString(r.replaceAll("\n",""),"text/html");t=o.querySelector(".bibtext a").getAttribute("href");const l=bibtexToString(await(await fetch(t)).text());var a=extractAuthor(l),t=await parseIdFromUrl(e),s=l.split("\n")[0].split("{")[1].replace(",","").trim(),e=cleanBiorxivURL(e)+".full.pdf",c=i.title,p=i.date.split("-")[0];return{author:a,bibtex:l,conf:"BioRxiv",id:t,key:s,note:"",pdfLink:e,title:c,venue:"",year:p}},makePMLRPaper=async e=>{var a=e.split("/").last().split(".")[0],t=await parseIdFromUrl(e);const n=e.includes(".html")?e:e.split("/").slice(0,-2).join("/")+`/${a}.html`;e=n.replace(".html","")+`/${a}.pdf`;const i=await fetchDom(n);i.getElementById("button-bibtex1").getAttribute("onclick").match(/https.+\.bib/)[0];const r=i.getElementById("bibtex").innerText.replaceAll("\t"," ").replaceAll(/\s\s+/g," ");let o=r;for(const u of r.match(/,\ ?\w+ ?= ?{/g))o=o.replace(u,u.replace(", ",",\n    ").replace(" = ","="));o.endsWith("}}")&&(o=o.slice(0,-2)+"}\n}"),o=bibtexToString(o);var l=extractAuthor(o),s=i.getElementsByTagName("h1")[0].innerText,c=extractBibtexValue(o,"year");let p=extractBibtexValue(o,"booktitle").replaceAll("Proceedings of the",""),d=p;note="Accepted @ "+p+`(${c})`;for(const h in global.overridePMLRConfs)if(p.includes(h)){d=global.overridePMLRConfs[h],p=d+" "+c,note="Accepted @ "+p;break}return{author:l,bibtex:o,conf:p,id:t,key:a,note:note,pdfLink:e,title:s,venue:d,year:c}},findACLValue=(e,a)=>{return Array.from(e.querySelectorAll("dt")).filter(e=>e.innerText.includes(a))[0].nextElementSibling.innerText},makeACLPaper=async e=>{e=e.replace(".pdf","");const a=await fetchDom(e);e=a.getElementById("citeBibtexContent");if(e){var t=a.getElementById("title").innerText,e=bibtexToString(e.innerText),n=bibtexToJson(e)[0];const s=n.entryTags;var i=s.year,r=s.author.replace(/\s+/g," ").split(" and ").map(e=>e.split(",").map(e=>e.trim()).reverse().join(" ")).join(" and "),n=n.citationKey,o=findACLValue(a,"Venue"),l=findACLValue(a,"PDF");return{author:r,bibtex:e,conf:o,id:`ACL-${o}-${i}_`+findACLValue(a,"Anthology ID"),key:n,note:`Accepted @ ${o} `+i,pdfLink:l,title:t,venue:o,year:i}}},makePNASPaper=async e=>{e=e.replace(".full.pdf","").replace(/\/doi\/e?pdf\//,"/doi/abs/");const a=await fetchDom(e);var t=a.getElementsByTagName("h1")[0].innerText,n=Array.from(a.querySelectorAll(".authors span[property='author'] a:not([property='email']):not(.orcid-id)")).filter(e=>!e.getAttribute("href").includes("mailto:")).map(e=>e.innerText).join(" and "),i=a.querySelector("span[property='datePublished']").innerText.match(/\d{4}/g)[0],r=`PNAS-${i}_`+(e.endsWith("/")?e.split("/").slice(-2):e.split("/").slice(-1))[0];const o=e.includes("/doi/pdf/")||e.includes("/doi/epdf/")?e.replace("/doi/epdf/","/doi/pdf/"):e.replace("/doi/abs/","/doi/pdf/").replace("/doi/full/","/doi/pdf/");var e=Array.from(a.querySelector(".self-citation").getElementsByTagName("a")).map(e=>e.getAttribute("href")).filter(e=>e.includes("https://doi.org"))[0].split("/").slice(-2).join("/"),l="doi:"+e;return{author:n,bibtex:bibtexToString(`@article{${l}, author={${n}}, title={${t}}, journal = {Proceedings of the National Academy of Sciences}, year={${i}}, doi={${e}}, eprint={${o}}, URL={${o.replace("/doi/pdf/","/doi/abs/")}} }`),id:r,key:l,note:`Published @ PNAS (${i})`,pdfLink:o,title:t,venue:"PNAS",year:i}},makeNaturePaper=async e=>{var a=(e=e.replace(".pdf","").split("#")[0])+".pdf",t=e.split("/").last();const n=await fetchDom(e);e=n.querySelector("h1.c-article-title").innerText;const i=Array.from(n.querySelectorAll("ul.c-article-author-list li")).map(e=>e.innerText.replace(/(\ ?,)|&|…|\d/g,"").split(/orcid/i)[0].trim()).filter(e=>0<e.length).join(" and ");var r=n.querySelector(".c-article-info-details").innerText.match(/\(\d{4}\)/)[0].replace(/\(|\)/g,""),o=n.querySelector(".c-article-info-details [data-test]").innerText,t="Nature_"+t,l=document.querySelector(".c-bibliographic-information__citation").innerText.split("https://doi.org/")[1],s="https://doi.org/"+l,c=""+i.split(" ")[1]+r+firstNonStopLowercase(e),l=bibtexToString(`@article{${c}, author={${i}}, title={${e}}, journal = {${o}}, year={${r}}, doi={${l}}, url={${s}} }`);return{author:i,bibtex:l,id:t,key:c,note:`Published @ ${o} (${r})`,pdfLink:a,title:e,venue:o,year:r}},makeACSPaper=async e=>{const a=(e=e.replace("pubs.acs.org/doi/pdf/","pubs.acs.org/doi/").split("?")[0]).replace("/abs/","/").split("/doi/")[1];console.log("doi: ",a);e=`https://pubs.acs.org/action/downloadCitation?doi=${a}&include=cit&format=bibtex&direct=true`,e=await fetchText(e);const t=bibtexToObject(e);var n=t.author.replaceAll("\n","").trim(),i=t.title.trim(),r=t.year.trim(),o=t.citationKey.trim(),l="https://pubs.acs.org/doi/pdf/"+a,s=`Published @ ${t.journal} (${t.year})`;return{author:n,bibtex:e,id:"ACS_"+a.replaceAll(".","").replaceAll("/",""),key:o,note:s,pdfLink:l,title:i,venue:t.journal,year:r}},makeIOPPaper=async e=>{(e=e.split("#")[0]).endsWith("/pdf")&&(e=e.slice(0,-4));const a=await fetchDom(e);var t=Array.from(a.querySelectorAll(".btn-multi-block a")).filter(e=>"BibTeX"===e.innerText).map(e=>e.getAttribute("href"))[0],t="https://"+parseUrl(e).host+t,t=await fetchText(t);const n=bibtexToObject(t);var i=n.author.replaceAll("\n","").trim(),r=n.title.trim(),o=n.year.trim(),l=n.citationKey.trim(),s=e+"/pdf",c=n.journal,p=`Published @ ${c} (${o})`;const d=e.split("/article/").last();return{author:i,bibtex:t,id:"IOPscience_"+d.replaceAll(".","").replaceAll("/",""),key:l,note:p,pdfLink:s,title:r,venue:c,year:o}},makeJMLRPaper=async e=>{var a=(e=(e=(e=e.includes("/papers/volume")?e.replace("/papers/volume","/papers/v"):e).endsWith(".pdf")?e.split("/").slice(0,-1).join("/"):e).replace(".html","")).split("/").last(),t=e+".bib",t=await fetchText(t);const{author:n,year:i,title:r,citationKey:o}=bibtexToObject(t);return{author:n,bibtex:t,id:`JMLR-${i}_`+a,key:o.trim(),note:`Published @ JMLR (${i})`,pdfLink:e.replace("/papers/v","/papers/volume")+`/${a}.pdf`,title:r,venue:"JMLR",year:i}},makePMCPaper=async e=>{var a=e.match(/PMC\d+/)[0].replace("PMC",""),t=e.split("PMC"+a)[0]+"PMC"+a;const n=await(await fetch(`https://api.ncbi.nlm.nih.gov/lit/ctxp/v1/pmc/?format=csl&id=${a}&download=true`)).json();var i=(n["epub-date"]||n.issued)["date-parts"][0][0],r=n.author.map(e=>e.given+" "+e.family).join(" and "),o=n["container-title"].split(" ").map(e=>e.capitalize()).join(" "),l=n.title,a=`PMC-${i}_`+a,s=""+n.author[0].family+i+firstNonStopLowercase(l),c=bibtexToString({entryType:"article",citationKey:s,journal:o,issn:n.ISSN,volume:n.volume,page:n.page,doi:n.DOI,PMID:n.PMID,PMCID:n.PMCID,publisher:n.publisher,author:r,title:l});let p;if(isPdfUrl(e))p=e;else{const h=n.DOI.split("/")[1].split("-");var e=h[0].match(/\d+/)[0],d=h[1].replace(h[1].match(/^0*/)[0],""),u=h[2].replace(h[2].match(/^0*/)[0],"");p=t+`/pdf/${e}_${d}_Article_${u}.pdf`}return{author:r,bibtex:c,id:a,key:s,note:`Published @ ${o} (${i})`,pdfLink:p,title:l,venue:o,year:i}},makePubMedPaper=async e=>{const a=await fetchDom(e.split("?")[0]),t=Array.from(a.getElementsByTagName("meta")).filter(e=>e.getAttribute("name")?.includes("citation_")),n=Object.fromEntries(t.map(e=>[e.getAttribute("name").replace("citation_",""),e.getAttribute("content")])),i=document.querySelector("div.authors-list").innerText.replace(/\d/gi,"").split(",").map(e=>e.trim()).join(" and ");var e=n.title,r=n.journal_title,o=n.date.split("/")[2],l=`PubMed-${o}_`+n.pmid,s=""+i.split(" and ")[0].split(" ").last()+o+firstNonStopLowercase(n.title),c={entryType:"article",citationKey:s,publisher:n.publisher,doi:n.doi,issn:n.issn,journal:r,year:o,author:i},c=bibtexToString(c),p=`Accepted @ ${journal} (${o})`;return{author:i,bibtex:c,id:l,key:s,note:p,pdfLink:"",title:e,venue:r,year:o}},makeIJCAIPaper=async e=>{const a=e.endsWith(".pdf")?e.replace(".pdf","").split("/").last().match(/[1-9]\d*/):e.split("/").last();e=e.match(/proceedings\/\d+/gi)[0].split("/")[1];const t=(await fetchText(`https://www.ijcai.org/proceedings/${e}/bibtex/`+a)).replace(/}\n/gi,"},\n");var n=bibtexToObject(t.split("\n").filter(e=>!/note\s+=/gi.test(e)).join("\n")),i=n.citationKey,r=n.title,n=flipAndAuthors(n.author),o=`IJCAI-${e}_`+a,l=`Accepted @ IJCAI (${e})`,s=a.padStart(4,0);return{author:n,bibtex:t,id:o,key:i,note:l,pdfLink:`https://www.ijcai.org/proceedings/${e}/${s}.pdf`,title:r,venue:"IJCAI",year:e}},makeACMPaper=async e=>{let a;a=isPdfUrl(e)?e:e.replace("/doi/","/doi/pdf/");const t=await fetchDom(e.replace("/doi/pdf/","/doi/"));var n=t.querySelector(".citation__title").innerText,i=Array.from(t.querySelectorAll("ul[ariaa-label='authors'] li.loa__item .loa__author-name")).map(e=>e.innerText.replace(",","").trim()).join(" and ");const r=t.querySelector(".issue-item__detail a").innerText;var o=r.split("'")[0].trim(),l="20"+r.split("'")[1].split(":")[0].trim();const s=a.split("/doi/pdf/")[1];var c=`Accepted @ ${o} (${l})`,p=s;return{author:i,bibtex:bibtexToString({entryType:"article",citationKey:s,journal:o,author:i,title:n,year:l,publisher:"Association for Computing Machinery",address:"New York, NY, USA",url:e.replace("/doi/pdf/","/doi/")}),id:`ACM-${l}_`+s.replaceAll(/(\.|\/)/gi,""),key:p,note:c,pdfLink:a,title:n,venue:o,year:l}},tryCrossRef=async e=>{try{var a="https://api.crossref.org/works?rows=1&mailto=schmidtv%40mila.quebec&select=event%2Ctitle&query.title="+encodeURI(e.title);const n=await fetch(a).then(e=>e.json());if("ok"!==n.status)return log(`[Crossref] ${a} returned `+n.message.status),{note:null};if(0===n.message.items.length)return{note:null};if(n.message.items[0].title[0].toLowerCase().replaceAll("\n"," ").replaceAll(/\s\s+/g," ")!==e.title.toLowerCase().replaceAll("\n"," ").replaceAll(/\s\s+/g," "))return{note:null};if(!n.message.items[0].event||!n.message.items[0].event.name)return{note:null};info("Found a CrossRef match");var t=n.message.items[0].event.name.trim();return{venue:t,note:`Accepted @ ${t} -- [crossref.org]`}}catch(e){return log("[Crossref]",e),{note:null}}},tryDBLP=async e=>{try{var a,t,n,i,r=encodeURI(e.title);const o=await fetch(`https://dblp.org/search/publ/api?q=${r}&format=json`).then(e=>e.json());if(!(o.result&&o.result.hits&&o.result.hits.hit&&o.result.hits.hit.length))return{note:null};for(const l of o.result.hits.hit.sort((e,a)=>parseInt(e.info.year,10)-parseInt(a.info.year,10)))if(decodeHtml(l.info.title.toLowerCase().replaceAll("\n"," ").replaceAll(".","").replaceAll(/\s\s+/g," "))===e.title.toLowerCase().replaceAll("\n"," ").replaceAll(".","").replaceAll(/\s\s+/g," ")&&"CoRR"!==l.info.venue)return info("Found a DBLP match"),a=await fetchText(l.info.url+".bib"),t=l.info.venue.toLowerCase().replaceAll(".","").trim(),n=(global.journalAbbreviations[t]||l.info.venue).trim(),i=l.info.year,l.info.url,{venue:n,note:`Accepted @ ${n} ${i} -- [dblp.org]`,bibtex:a};return{note:null}}catch(e){return log("[DBLP]",e),{note:null}}},tryPreprintMatch=async e=>{let a,t,n;return dblpMatch=await tryDBLP(e),a=dblpMatch.note,t=dblpMatch.venue,n=dblpMatch.bibtex,a||(log("[DBLP] No publication found"),crossRefMatch=await tryCrossRef(e),a=crossRefMatch.note,t=crossRefMatch.venue),a||log("[CrossRef] No publication found"),{note:a,venue:t,bibtex:n}},initPaper=async e=>{e.note||(e.note=""),e.md=`[${e.title}](${e.pdfLink})`,e.tags=[],e.codeLink="",e.favorite=!1,e.favoriteDate="",e.addDate=(new Date).toJSON(),e.lastOpenDate=e.addDate,e.count=1,e.code={};for(const a in e)e.hasOwnProperty(a)&&"string"==typeof e[a]&&(e[a]=e[a].trim());return e=await autoTagPaper(e),validatePaper(e),e},autoTagPaper=async t=>{try{var e,n,i=await getStorage("autoTags");if(!i||!i.length)return t;let a=new Set;for(const r of i)r.tags?.length&&(r.title||r.author)&&(e=!r.title||new RegExp(r.title,"i").test(t.title),n=!r.author||new RegExp(r.author,"i").test(t.author),e&&n&&r.tags.forEach(e=>a.add(e)));return t.tags=Array.from(a).sort(),t.tags.length&&log("Automatically adding tags:",t.tags),t}catch(e){return log("Error auto-tagging:",e),log("Paper:",t),t}},makePaper=async(e,a,t)=>{let n;if(e.arxiv)(n=await makeArxivPaper(t)).source="arxiv";else if(e.neurips)(n=await makeNeuripsPaper(a)).source="neurips";else if(e.cvf)(n=await makeCVFPaper(a)).source="cvf";else if(e.openreview)(n=await makeOpenReviewPaper(a)).source="openreview";else if(e.biorxiv)(n=await makeBioRxivPaper(a)).source="biorxiv";else if(e.pmlr)(n=await makePMLRPaper(a)).source="pmlr";else if(e.acl)(n=await makeACLPaper(a))&&(n.source="acl");else if(e.pnas)(n=await makePNASPaper(a))&&(n.source="pnas");else if(e.nature)(n=await makeNaturePaper(a))&&(n.source="nature");else if(e.acs)(n=await makeACSPaper(a))&&(n.source="acs");else if(e.iop)(n=await makeIOPPaper(a))&&(n.source="iop");else if(e.jmlr)(n=await makeJMLRPaper(a))&&(n.source="jmlr");else if(e.pmc)(n=await makePMCPaper(a))&&(n.source="pmc");else if(e.ijcai)(n=await makeIJCAIPaper(a))&&(n.source="ijcai");else{if(!e.acm)throw new Error("Unknown paper source: "+JSON.stringify({is:e,url:a,id:t}));(n=await makeACMPaper(a))&&(n.source="acm")}if(void 0!==n)return initPaper(n)},findFuzzyPaperMatch=e=>{for(const t in global.state.papers)if("__dataVersion"!==t){var a=global.state.papers[t];if(Math.abs(a.title.length-e.title.length)<global.fuzzyTitleMatchMinDist)if(levenshtein(a.title,e.title)<global.fuzzyTitleMatchMinDist)return a.id}return null};